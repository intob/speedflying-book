...
Here we reach a crux, an intersection between optimal piloting and appropriate advice for less experienced pilots. I suggest that newer pilots do not experiment with bridge input until very familiar with brake input, rear riser input, and also [stall point](../08_stall_point) on the ground, across all methods of control.
...
If I encounter turbulence, I increase my AoA immediately using the bridge.

I do not recommend that you try to imitate my flying style, but take your time to master all techniques of glider control, with a focus on weight-shift. Again, weight-shift must be the primary mechanism of control.
